...
0.1.0 - начало разработки, всё ещё слишком далеко от продукта и может быть полностью переделано.
Для перехода на 1.0.0 должна быть реализована запланированная первоначальная функциональность в полном объеме, фичи доведены до стабильного состояния.
Тег сделан аннотированным, чтобы корректно отображался в GitHUb на странице Releases - здесь только annotated.
...
13c5f664bd55505720e05ccac65ae8d81e0ae5bd
$ git rev-parse HEAD
61344285f71e2dd1f5dc61291bbbe66d713fdccb
```
